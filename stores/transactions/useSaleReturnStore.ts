import {
  SaleReturnLineApiItem,
  SaleReturnTableRow,
} from "@/modules/sales-return/sales-return.types";
...
interface SaleReturnStore {
  ...
  setTransactionInformation: (
    data: SaleReturnStore["transaction_information"],
  ) => void;

  lines: SaleReturnTableRow[];
  setLines: (lines: SaleReturnLineApiItem[]) => void;
  ...
  setMeta: (data: SaleReturnStore["meta"]) => void;
