...
export default function PaymentInformation() {
  ...
  const transactionInformation = useDeleteSalesPaymentStore(
  ...
  const onSubmit = (data: PaymentInformationFormField) => {
    ...
    useDeleteSalesPaymentStore.getState().setTransactionInformation({
      client: data.client,
      transaction_id: data.transaction_id,
    });

    useDeleteSalesPaymentStore.getState().setMeta({
