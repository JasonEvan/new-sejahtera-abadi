...
import { useDeletePurchasePaymentTransactionMutation } from "@/modules/purchase-payment/purchase-payment.mutations";
...
export default function PaymentSummary() {
  const { transaction_information, meta } = useDeletePurchasePaymentStore();
  const deletePaymentMutation = useDeletePurchasePaymentTransactionMutation();
        ...
        <Button
          ...
          onClick={() =>
            alertDialogs.open({
              ...
              description: `Apakah Anda yakin ingin menghapus transaksi pembayaran ${meta.transaction_number}? Tindakan ini akan mengembalikan saldo hutang klien dan sisa tagihan pada nota terkait. Tindakan ini tidak dapat dibatalkan.`,
              confirmText: "Hapus",
