import { SalesInvoiceRow } from "@/modules/sale/sale.types";
import { createColumnHelper } from "@tanstack/react-table";
import Link from "next/link";

const columnHelper = createColumnHelper<SalesInvoiceRow>();
...
export const columns = [
  ...
  columnHelper.accessor("invoice_number", {
    ...
    cell: (info) => (
      <Link
        href={`/view/sales-invoice/${encodeURIComponent(info.getValue())}`}
