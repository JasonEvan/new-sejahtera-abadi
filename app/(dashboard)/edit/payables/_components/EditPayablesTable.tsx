...
import { useGetEditPayablesByInvoice } from "@/modules/purchase-payment/purchase-payment.queries";
...
export default function EditPayablesTable() {
  ...
  const { data, isFetching, isError, error } = useGetEditPayablesByInvoice(
    searchInvoiceNumber,
    !!searchInvoiceNumber,
  );
