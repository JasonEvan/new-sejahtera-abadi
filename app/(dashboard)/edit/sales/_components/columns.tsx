...
const columnHelper = createColumnHelper<EditSaleItemRow>();

export const useColumns = () => {
  function handleItemEdit(data: EditSaleItemRow) {
    dialogs.open({
      title: "Edit Item",
      description: "Ubah item pada nota",
      type: "form",
      formId: "edit-sale-item-form",
  ...
  function handleItemDelete(id: string) {
    alertDialogs.open({
      ...
      onConfirm: () => {
        alertDialogs.close();
        useEditSaleStore.getState().removeItem(id);
      },
    });
  }
